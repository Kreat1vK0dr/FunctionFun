...
var eating_out_noregex = require('../eating-out_noregex');
...
describe("eating_out_noregex", function() {

    it("should extract the items and their respective quantities", function() {
      var result = eating_out_noregex.getQuantity(m1);
    ...
    it("should extract the items and their respective prices", function() {
      var result = eating_out_noregex.getPrice(m2);
    ...
    it("should return the item, its quantity, price and subtotal", function() {
      var result = eating_out_noregex.getBill(m1, m2);
    ...
    it("should return the total to be EFT'd", function() {
      var result = eating_out_noregex.toPay(m1, m2);
